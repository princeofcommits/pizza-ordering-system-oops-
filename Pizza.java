public class Pizza { int price; String pizza;String bill=""; int basepizza; int veg=200;int non_veg=285;
   private int extracheese=99;private int extratoppings=150; private int packaging=25; boolean isfarm_pizza=false; private boolean isextrachesseaded=false;private boolean isextratopingsaded=false;private boolean isetakeaway=false;
    public void bill(){
   ...
   public Pizza(String pizza) {
    ...
    public void addextracheese(){price+=extracheese; isextrachesseaded=true;}public void addextratoppings(){price+=extratoppings; isextratopingsaded=true;}public void takeaway(){price+=packaging;isetakeaway=true;}
    ...
    public static void main(String[] args) {
        Pizza mypizzza=new Pizza("nonveg");
         mypizzza.addextracheese(); mypizzza.takeaway(); mypizzza.bill(); farm_pizza p=new farm_pizza("veg"); p.bill();
    }
}
